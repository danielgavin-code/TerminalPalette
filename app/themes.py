...
THEMES = [
    ...
    _theme(26, "desert-clay", "Desert Clay",
    ...
    _theme(28, "ivory-console", "Ivory Console",
    ...
    # --- 44 --------------------------------------------------------------
    _theme(31, "closing-bell", "Closing Bell",
